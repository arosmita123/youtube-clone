...
const VideoCard = ({ info }) => {
    ...
    return (
        <div className='p-2 m-2  shadow-lg  min-h-72 w-[350px] my-10  hover:cursor-pointer'>
            <img className="h-48 w-[350px] object-cover rounded-xl hover:rounded-none duration-300" src={info.snippet.thumbnails.medium.url} alt='thumbnail' />
            <div>
